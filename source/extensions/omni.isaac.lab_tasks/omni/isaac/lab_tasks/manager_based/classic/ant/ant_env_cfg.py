...
class ObservationsCfg:
    ...
    class PolicyCfg(ObsGroup):
        ...
        base_angle_to_target = ObsTerm(func=mdp.base_angle_to_target,
        ...
        feet_body_forces = ObsTerm(
            ...
            params={
                "asset_cfg": SceneEntityCfg(
                    "robot", body_names=["front_left_foot", "front_right_foot",
...
FORWARD_DIR = (1000.0, 0.0, 0.0)
UP_DIR = (0.0, 0.0, 1000.0)
...
class RewardsCfg:
    ...
    progress = RewTerm(func=mdp.progress_reward, weight=1.0,
                       params={
                           #    "target_pos": FORWARD_DIR
                           "target_pos": UP_DIR
                       })
    # (2) Stay alive bonus
    alive = RewTerm(func=mdp.is_alive, weight=0.5)
    # (3) Reward for non-upright posture
    upright = RewTerm(func=mdp.upright_posture_bonus, weight=0.1,
                      params={"threshold": 0.93})
    # (4) Reward for moving in the right direction
    move_to_target = RewTerm(
        func=mdp.move_to_target_bonus, weight=0.5,
        params={
            "threshold": 0.8,
            # "target_pos": FORWARD_DIR
            "target_pos": UP_DIR
    ...
    energy = RewTerm(func=mdp.power_consumption, weight=-0.05,
                     params={"gear_ratio": {".*": 15.0}})
    # (7) Penalty for reaching close to joint limits
    joint_limits = RewTerm(
        func=mdp.joint_limits_penalty_ratio, weight=-0.1,
